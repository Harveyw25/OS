...
void cRobin::addToIOBlockedQueue(PCB *pcbToAdd, std::ofstream& logOutput, int timeCycle)
{
...
void cRobin::addToUserBlockedQueue(PCB* pcbToAdd, std::ofstream& logOutput, int timeCycle)
{
    pcbToAdd->setTimeEnteredBlock(timeCycle);
