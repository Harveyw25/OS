...
void cRoundRobinRandom::addToIOBlockedQueue(PCB *pcbToAdd, std::ofstream& logOutput, int timeCycle)
{
...
void cRoundRobinRandom::addToUserBlockedQueue(PCB* pcbToAdd, std::ofstream& logOutput, int timeCycle)
{
    pcbToAdd->setTimeEnteredBlock(timeCycle);
